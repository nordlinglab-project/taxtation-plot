...
plt.scatter(get_year_tax(2006), get_year_price(2006), sizes=[0.25])
...
plt.scatter(get_year_tax(2007), get_year_price(2007), sizes=[0.25])
...
plt.scatter(get_year_tax(2008), get_year_price(2008), sizes=[0.25])
